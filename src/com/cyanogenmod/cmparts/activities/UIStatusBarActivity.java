...
public class UIStatusBarActivity extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    private static final String PREF_STATUS_BAR_HIDECENTERCLOCK = "pref_status_bar_hidecenterclock";
    ...
    private CheckBoxPreference mStatusBarHideCenterClock;
	...
	mStatusBarAlarm = (CheckBoxPreference) prefSet.findPreference(PREF_STATUS_BAR_ALARM);
        ...
        mStatusBarHideCenterClock = (CheckBoxPreference) prefSet.findPreference(PREF_STATUS_BAR_HIDECENTERCLOCK);
	...
	mStatusBarAlarm.setChecked((Settings.System.getInt(getContentResolver(),
        ...
        mStatusBarHideCenterClock.setChecked((Settings.System.getInt(getContentResolver(),
                Settings.System.STATUS_BAR_HIDECENTERCLOCK, 0) == 1));
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if(preference == mRestartStatusBar) {
            ...
            Settings.System.putInt(getContentResolver(), Settings.System.STATUS_BAR_CENTERCLOCK,
                    value ? 1 : 0);
            // Just enable the option to hide centered clock if centered clock is set.
            mStatusBarHideCenterClock.setEnabled(value);
            return true;
        } else if (preference == mStatusBarHideCenterClock) {
            value = mStatusBarHideCenterClock.isChecked();
            Settings.System.putInt(getContentResolver(), Settings.System.STATUS_BAR_HIDECENTERCLOCK,
                    value ? 1 : 0);
            return true;
